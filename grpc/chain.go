// The source code are copied and adapted from http://github.com/mwitkow/go-grpc-middleware.
package grpc
...
// ChainUnaryServer creates a single interceptor out of a chain of
// many interceptors.
//
// Execution is done in left-to-right order, including passing of context.
// For example ChainUnaryServer(one, two, three) will execute one before
// two before three, and three will see context changes of one and two.
func ChainUnaryServer(interceptors ...grpc.UnaryServerInterceptor) grpc.UnaryServerInterceptor {
	glog.V(3).Infof("Enter ChainUnaryServer maker")
...
// ChainStreamServer creates a single interceptor out of a chain of
// many interceptors.
//
// Execution is done in left-to-right order, including passing of context.
// For example ChainUnaryServer(one, two, three) will execute one before
...
func ChainStreamServer(interceptors ...grpc.StreamServerInterceptor) grpc.StreamServerInterceptor {
	glog.V(3).Infof("Enter ChainStreamServer maker")
...
// ChainUnaryClient creates a single interceptor out of a chain of
// many interceptors.
//
// Execution is done in left-to-right order, including passing of context.
// For example ChainUnaryClient(one, two, three) will execute one before
// two before three.
func ChainUnaryClient(interceptors ...grpc.UnaryClientInterceptor) grpc.UnaryClientInterceptor {
	glog.V(3).Infof("Enter ChainUnaryClient maker")
...
// ChainStreamClient creates a single interceptor out of a chain of
// many interceptors.
//
// Execution is done in left-to-right order, including passing of context.
// For example ChainStreamClient(one, two, three) will execute one before
// two before three.
...
// WithUnaryServerChain returns a grpc server config option that accepts
// multiple unary interceptors.
func WithUnaryServerChain(interceptors ...grpc.UnaryServerInterceptor) grpc.ServerOption {
	return grpc.UnaryInterceptor(ChainUnaryServer(interceptors...))
}

// WithStreamServerChain returns a grpc server config option that accepts
// multiple stream interceptors.
